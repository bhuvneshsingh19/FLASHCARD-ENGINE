          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href={isSignedIn ? "/dashboard" : "/signup"}>
                <Button size="lg" className="h-16 px-10 text-lg gap-3 rounded-2xl shadow-xl shadow-blue-200 transition-transform hover:scale-105 active:scale-95 bg-blue-600 hover:bg-blue-700 text-white">
                  {isSignedIn ? "Go to Dashboard" : "Get Started for Free"} <ArrowRight size={20} />
                </Button>
              </Link>
              <Link href={isSignedIn ? "/dashboard" : "/login"}>
                <Button variant="secondary" size="lg" className="h-16 px-10 text-lg rounded-2xl bg-white/60 backdrop-blur-md hover:bg-white border border-gray-200 text-gray-700 shadow-sm transition-all">
                  View My Library
                </Button>
              </Link>
            </div>
